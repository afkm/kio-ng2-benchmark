...
import { DataComponent, ContentDataComponent, FragmentDataComponent } from '../../../component-routing/module'
import { ContentMockingService, getAllComponents, getComponentIndexForNode, getComponentAt } from 'kio-ng2-component-routing'
import * as KioComponentFactory from '../../../component-routing/factory'
import { defaultStore } from '../../../component-routing/module'
import { NODE_MODEL } from '../../../component-routing/node-model.token'
...
export class ComponentBuilderComponent implements OnInit {
  ...
  getComponentItem(node:KioContentModel) {
    const idx = getComponentIndexForNode(node)
    if ( idx > -1 ) {
      const componentItem = getComponentAt(idx)
  ...
  mountComponent() {
    ...
    this.component = KioComponentFactory.createComponentItemOnViewContainer ( 
      componentItem,
